/* Voltaire Tech — content as plain data. Edit values here and the site updates.
   Mirrors the brief's "All copy in /content as TS objects" — JS for the static prototype. */

window.VT_CONTENT = {
  brand: {
    name: "VOLTAIRTECH",
    nameRich: { pre: "VOLT", ai: "AI", post: "R TECH" },
